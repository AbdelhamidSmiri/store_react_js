...
export function FavoriButton() {
    ...
    return (
        <>
            <button type="button" className="bg-primary w-16 h-full rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="#5f676f" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="25" height="25">
